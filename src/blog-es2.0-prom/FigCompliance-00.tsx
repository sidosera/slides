...
function CoverageBackdrop() {
  const line =
    "M 74 292 C 205 282, 324 264, 450 220 C 560 190, 650 170, 748 148 C 834 128, 902 116, 962 104"
      ...
      {queries.map((query, i) => (
        <g key={query.color}>
          <rect
            ...
            width={214}
            height={17.5}
            fill={i === 1 ? "rgba(11,100,221,0.04)" : "rgba(255,255,255,0.24)"}
            stroke={i === 1 ? "rgba(11,100,221,0.24)" : "transparent"}
            strokeWidth={0.5}
          />
          <circle
            cx={x + 24}
...
export function Figure08Methodology() {
  return (
    ...
    >
      ...
      <g
        opacity={0.86}
        transform="translate(48 94) scale(1.13) translate(-62 -100)"
      >
      ...
      <PhaseLabel
        x={712}
        y={306}
        lines={["COMPARE RESULTS", "WITH PROMETHEUS"]}
      />
